...
function Challenge() {
    return (
        <div>
            <Header/>
            <div className={"container " + styles.challenge_container}>
                <h1 className="text-center">Automated Sampling in Wastewater Intelligence Network</h1>
                <div className="text-center">
                    <a href="https://cityinx.niua.org/challenge/196/anchor/87" target="_blank"><button type="button" class="btn btn-primary">Apply for the challenge on City Innovation Exchange</button></a>
                </div>
                ...
                <h3>Profile of Target Beneficiaries</h3>
                ...
                <h6>Functional requirements of the end-user</h6>
                ...
                <h6>Functional &amp; Operational capabilities</h6>
                ...
                <h3>Expected Tangible Outcomes &amp; Benefits</h3>
                <ul>
                ...
                <h3>Gaps in current solution</h3>
                <ul>

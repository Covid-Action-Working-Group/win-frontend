  ...
  return (
    <div className="font-body ">
      ...
      <div className = " text-center content-center px-4 md:px-12">
        ...
        <div className="mt-16 lg:mt-24 mx-14 sm:mx-28 xl:mx-56 grid grid-flow-col grid-row-1 lg:grid-rows-1 grid-col-2 lg:grid-cols-2 w-auto" >

    ...
    <div className="font-body ">
      ...
      <header className="flex m-0 w-full py-6 px-4 space-x-4  md:inline-flex bg-transparent ...">
        <span className="col-span-1 ml-8 sm:ml-10 md:ml-20 ">
          <img src="/icons/hero_logo.svg" alt="logo" layout='fill' objectFit='contain' className="w-2/5 sm:w-1/2 md:w-2/3 "/>
        </span>
      ...
      <div className = " text-center content-center px-12">
        ...
        <div className="mt-28 sm:mt-28 md:mt-32 mx-60 max-w-screen-lg mx-auto">
          <img src="/icons/Group 331.svg" alt="logo" layout='fill' objectFit='contain' className="w-1/3 mx-auto"/>
        </div>
        ...
        <div className="w-full">
          ...
          {/* <div className="w-full h-full mx-32 border-dotted pb-36 border-b-4 border-red-400 "> */}
            <img src="/icons/WBE.svg" alt="logo" layout='fill' objectFit='contain' className="w-full h-full mt-12 sm:mt-12 md:mt-20 px-4 md:px-12"/>
          {/* </div> */}
        </div>

        <div class="mt-16 sm:mt-20 lg:mt-24 mb-11 sm:mb-12 lg:mb-16 grid grid-flow-col grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
          <div className=" w-1/5 lg:w-1/3 lg:mr-20 mt-20 md:mt-16 lg:mt-8  col-start-1 row-start-1 max-w-screen-sm mx-auto content-center ">
            <img src="/icons/sneezing.svg" alt="logo" layout='fill' objectFit='contain' className=" mx-auto "/>
          </div>
        ...
        <div class="mt-16 sm:mt-20 lg:mt-24 mb-11 sm:mb-12 lg:mb-16 grid grid-flow-col grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
          ...
          <div className=" w-1/5 lg:w-1/3 lg:mt-20 xl:mt-9 lg:ml-24 col-start-1 lg:col-start-3 row-start-1 max-w-screen-sm mx-auto content-center ">
            <img src="/icons/Shedding.svg" alt="logo" layout='fill' objectFit='contain' className=" mx-auto "/>
          </div>
        </div>

        <div class="mt-16 sm:mt-20 lg:mt-24 mb-11 sm:mb-12 lg:mb-16 grid grid-flow-col grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
          <div className=" w-1/5 lg:w-1/3 lg:mr-20 mt-20 md:mt-16 lg:mt-8  -pb-60 col-start-1 row-start-1 max-w-screen-sm mx-auto content-center ">
            <img src="/icons/Sample Collection.svg" alt="logo" layout='fill' objectFit='contain' className=" mx-auto "/>
          </div>
          <div className="text-center lg:text-left col-start-1 lg:col-start-2 col-span-1 lg:col-span-2 pt-6">
        ...
        <div class="mt-16 sm:mt-20 lg:mt-24 mb-11 sm:mb-12 lg:mb-16 grid grid-flow-col grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
          ...
          <div className=" w-1/5 lg:w-1/3 lg:mt-20 lg:mt-6 lg:ml-24 col-start-1 lg:col-start-3 row-start-1 max-w-screen-sm mx-auto content-center ">
            <img src="/icons/Sample Concentration.svg" alt="logo" layout='fill' objectFit='contain' className=" mx-auto "/>
          </div>
        </div>

        <div class="mt-16 sm:mt-20 lg:mt-24 mb-11 sm:mb-12 lg:mb-16 grid grid-flow-col grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
          <div className=" w-1/5 lg:w-1/3 lg:mr-20 mt-20 md:mt-16 lg:mt-8  -pb-60 col-start-1 row-start-1 max-w-screen-sm mx-auto content-center ">
            <img src="/icons/RNA Extraction.svg" alt="logo" layout='fill' objectFit='contain' className="mx-auto "/>
          </div>
          <div className="text-center lg:text-left col-start-1 lg:col-start-2 col-span-1 lg:col-span-2 pt-6">
        ...
        <div class="mt-16 sm:mt-20 lg:mt-24 mb-11 sm:mb-12 lg:mb-16 grid grid-flow-col grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
          ...
          <div className="w-1/5 lg:w-1/3 lg:mt-20 xl:mt-0 lg:ml-24 col-start-1 lg:col-start-3 row-start-1 max-w-screen-sm mx-auto content-center ">
            <img src="/icons/RNA Measurement.svg" alt="logo" layout='fill' objectFit='contain' className=" mx-auto "/>
          </div>
        </div>

        <div class="mt-16 sm:mt-20 lg:mt-24 mb-11 sm:mb-12 lg:mb-16 grid grid-flow-col grid-rows-2 lg:grid-rows-1 grid-cols-1 lg:grid-cols-3 gap-2 lg:gap-4">
          <div className=" w-1/5 lg:w-1/3 lg:mr-20 mt-20 md:mt-16 lg:mt-8  -pb-60 col-start-1 row-start-1 max-w-screen-sm mx-auto content-center ">
            <img src="/icons/Data Analytics.svg" alt="logo" layout='fill' objectFit='contain' className="mx-auto "/>
          </div>
          <div className="text-center lg:text-left col-start-1 lg:col-start-2 col-span-1 lg:col-span-2 pt-6">
        ...
        <div className="text-2xl mt-10 sm:mt-14 lg:mt-24 mb-4 lg:mb-10 mx-36 md:mx-24 lg:mx-44 grid grid-flow-col grid-row-3 md:grid-rows-1 grid-col-1 md:grid-cols-3 gap-3 md:gap-6 lg:gap-8 " >
          <div className="bg-light-yellow row-start-1 ">
            <img src="/icons/Early Warning.svg" alt="logo" layout='fill' objectFit='contain' className="w-1/5  mx-auto mt-6"/>
          ...
          <div className="bg-light-yellow row-start-2 md:row-start-1">
            <img src="/icons/Tracking the spread.svg" alt="logo" layout='fill' objectFit='contain' className="w-1/5  mx-auto mt-6"/>
          ...
          <div className="bg-light-yellow row-start-3 md:row-start-1 ">
            <img src="/icons/Containment zones.svg" alt="logo" layout='fill' objectFit='contain' className="w-1/5  mx-auto mt-6"/>
            <p className="px-10 py-6"><span className="font-bold">Identification of hotspots</span> and containment zones</p>
          </div>
        </div>

        <div className="text-2xl lg:mt-12 mb-6 lg:mb-10 mx-36 md:mx-56 lg:mx-80 grid grid-flow-col grid-row-2 md:grid-rows-1 grid-col-1 md:grid-cols-2 gap-3 md:gap-10 lg:gap-20" >
          <div className="bg-light-yellow row-start-1 ">
            <img src="/icons/Testing strategy.svg" alt="logo" layout='fill' objectFit='contain' className="w-1/5 mx-auto mt-6"/>
            <p className="px-10 py-6"><span className="font-bold">Optimising testing strategy</span> & allocation of resources</p>
          </div>
          <div className="bg-light-yellow row-start-2 md:row-start-1 ">
            <img src="/icons/Timely Updates.svg" alt="logo" layout='fill' objectFit='contain' className="w-1/5 mx-auto mt-6"/>
        ...
        <div>
          ...
          <div className="mt-20 mb-16 mx-96 max-w-screen-lg mx-auto">
            <img src="/icons/Group 331.svg" alt="logo" layout='fill' objectFit='contain' className="w-3/5 lg:w-4/5 px-8 mt-6 mb-8 mx-auto"/>
          </div>
        </div>
